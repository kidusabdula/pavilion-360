// components/venues/venues-client-view.tsx
'use client';
...
interface VenuesClientViewProps {
  initialVenues: Venue[];
...
export function VenuesClientView({
  ...
  }, [initialVenues, searchQuery, activeCapacity, activeEventType]);
  ...
  // Build event type options including "All"
  const eventTypeOptions: (EventType | 'All')[] = [
    'All',
    ...eventTypes.map((et) => et.name as EventType),
  ];
