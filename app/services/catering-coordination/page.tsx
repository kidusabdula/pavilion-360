...
export const metadata: Metadata = {
  ...
  description: "Full-service catering management with trusted partners for exceptional event dining experiences.",
}

export default function ServicePage() {
  const service = services.find((s) => s.slug === "catering-coordination")
  if (!service) notFound()
  ...
  return (
    <div className="flex flex-col">
      <HeroSection
        ...
        backgroundImage="/catering-coordination-food-service.jpg"
        size="medium"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-border bg-muted/30 p-8 text-center sm:flex-row sm:justify-between sm:text-left">
              <div>
                <h3 className="mb-2 text-xl font-bold">Ready to plan your menu?</h3>
                <p className="text-muted-foreground">
                  Connect with our catering partners for a custom culinary experience.
                </p>
              </div>
