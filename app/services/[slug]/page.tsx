        ...
        <section className="border-t border-border py-20 lg:py-32">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
              See our {service.name.toLowerCase()} work in action
            </p>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {service.gallery.map((image, index) => {
                // Generate SEO-friendly alt text from whatWeDo items
                const altKeywords =
      ...
      <section className="border-t border-border bg-accent py-20 text-background lg:py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-8 text-lg opacity-90">
            Contact us today to discuss how we can bring your event vision to
            life.
          </p>
          <Link
            href="/contact"
