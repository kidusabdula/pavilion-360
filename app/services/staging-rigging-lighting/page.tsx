...
export const metadata: Metadata = {
  title: "Staging, Rigging & Lighting",
  description: "Professional stage builds, truss systems, and intelligent lighting design for any event scale.",
}

export default function ServicePage() {
  const service = services.find((s) => s.slug === "staging-rigging-lighting")
  if (!service) notFound()
  ...
  return (
    <div className="flex flex-col">
      <HeroSection
        ...
        backgroundImage="/staging-rigging-lighting.jpg"
        size="medium"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-border bg-muted/30 p-8 text-center sm:flex-row sm:justify-between sm:text-left">
              <div>
                <h3 className="mb-2 text-xl font-bold">Need a professional stage setup?</h3>
                <p className="text-muted-foreground">Let's design the perfect stage and lighting for your event.</p>
              </div>
