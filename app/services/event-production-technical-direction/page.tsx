...
export const metadata: Metadata = {
  title: "Event Production & Technical Direction",
  description: "Expert technical direction and show calling for complex multi-day events and productions.",
}

export default function ServicePage() {
  const service = services.find((s) => s.slug === "event-production-technical-direction")
  if (!service) notFound()
  ...
  return (
    <div className="flex flex-col">
      <HeroSection
        ...
        backgroundImage="/event-production-technical-direction.jpg"
        size="medium"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-border bg-muted/30 p-8 text-center sm:flex-row sm:justify-between sm:text-left">
              <div>
                <h3 className="mb-2 text-xl font-bold">Need expert production management?</h3>
                <p className="text-muted-foreground">Our technical directors ensure seamless event execution.</p>
              </div>
