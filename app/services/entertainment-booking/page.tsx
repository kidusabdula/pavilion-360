...
export const metadata: Metadata = {
  ...
  description: "Curated entertainment from DJs and live bands to specialty acts for memorable events.",
}

export default function ServicePage() {
  const service = services.find((s) => s.slug === "entertainment-booking")
  if (!service) notFound()
  ...
  return (
    <div className="flex flex-col">
      <HeroSection
        ...
        backgroundImage="/entertainment-booking-live-music.jpg"
        size="medium"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-border bg-muted/30 p-8 text-center sm:flex-row sm:justify-between sm:text-left">
              <div>
                <h3 className="mb-2 text-xl font-bold">Ready to book entertainment?</h3>
                <p className="text-muted-foreground">Let's find the perfect performers for your event.</p>
              </div>
