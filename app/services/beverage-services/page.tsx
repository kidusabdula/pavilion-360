...
export const metadata: Metadata = {
  ...
  description: "Bar setup, bartenders, beverage packages, and bar rental coordination for your event.",
}

export default function ServicePage() {
  const service = services.find((s) => s.slug === "beverage-services")
  if (!service) notFound()
  ...
  return (
    <div className="flex flex-col">
      <HeroSection
        ...
        backgroundImage="/beverage-services-bar-setup.jpg"
        size="medium"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-border bg-muted/30 p-8 text-center sm:flex-row sm:justify-between sm:text-left">
              <div>
                <h3 className="mb-2 text-xl font-bold">Ready to raise a glass?</h3>
                <p className="text-muted-foreground">Let's create a custom bar experience for your event.</p>
              </div>
