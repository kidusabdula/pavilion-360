...
export const metadata: Metadata = {
  ...
  description: "Custom scenic design, branding, and visual experiences that bring your event vision to life.",
}

export default function ServicePage() {
  const service = services.find((s) => s.slug === "creative-design")
  if (!service) notFound()
  ...
  return (
    <div className="flex flex-col">
      <HeroSection
        ...
        backgroundImage="/creative-event-design.jpg"
        size="medium"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-border bg-muted/30 p-8 text-center sm:flex-row sm:justify-between sm:text-left">
              <div>
                <h3 className="mb-2 text-xl font-bold">Ready to transform your event space?</h3>
                <p className="text-muted-foreground">Let's create an unforgettable environment together.</p>
              </div>
