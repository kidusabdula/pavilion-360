...
export const metadata: Metadata = {
  title: "Furniture & Soft Seating Rentals",
  description: "Stylish lounge furniture, ottomans, bars, and custom seating for comfortable event spaces.",
}

export default function ServicePage() {
  const service = services.find((s) => s.slug === "furniture-soft-seating-rentals")
  if (!service) notFound()
  ...
  return (
    <div className="flex flex-col">
      <HeroSection
        ...
        backgroundImage="/furniture-soft-seating-lounge.jpg"
        size="medium"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-border bg-muted/30 p-8 text-center sm:flex-row sm:justify-between sm:text-left">
              <div>
                <h3 className="mb-2 text-xl font-bold">Browse our furniture collection</h3>
                <p className="text-muted-foreground">Discover stylish pieces for your next event.</p>
              </div>
