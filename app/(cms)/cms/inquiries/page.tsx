...
export default function InquiriesPage() {
  ...
  const { data, isLoading, error } = useInquiries({ status: statusFilter !== 'all' ? statusFilter : undefined });
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-6 text-center">
          <p className="text-red-500">Failed to load inquiries: {error.message}</p>
        </div>
      </div>
    );
  }
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              ...
              render: (inquiry) => <p className="truncate">{inquiry.message}</p>,
            },
            {
              key: 'created_at',
              label: 'Received',
