...
export const queryKeys = {
  ...
  portfolio: {
    ...
    list: (filters?: PortfolioFilters) => [...queryKeys.portfolio.all, 'list', filters] as const,
  ...
  faqs: {
    all: ['faqs'] as const,
    list: (filters?: FAQFilters) => [...queryKeys.faqs.all, 'list', filters] as const,
  ...
  blog: {
    all: ['blog'] as const,
    list: (filters?: BlogFilters) => [...queryKeys.blog.all, 'list', filters] as const,
...
export const cmsQueryKeys = {
  ...
  services: {
    ...
    list: (params?: ListParams) => [...cmsQueryKeys.services.all, 'list', params] as const,
    detail: (id: string) => [...cmsQueryKeys.services.all, 'detail', id] as const,
  },
  
  // Rentals
  rentals: {
    all: ['cms', 'rentals'] as const,
    list: (params?: ListParams) => [...cmsQueryKeys.rentals.all, 'list', params] as const,
    detail: (id: string) => [...cmsQueryKeys.rentals.all, 'detail', id] as const,
  },
  ...
  rentalCategories: {
    ...
    detail: (id: string) => [...cmsQueryKeys.rentalCategories.all, 'detail', id] as const,
  },
  
  // Portfolio
  portfolio: {
    all: ['cms', 'portfolio'] as const,
    list: (params?: ListParams) => [...cmsQueryKeys.portfolio.all, 'list', params] as const,
    detail: (id: string) => [...cmsQueryKeys.portfolio.all, 'detail', id] as const,
  },
  
  // Venues
  venues: {
    all: ['cms', 'venues'] as const,
    list: (params?: ListParams) => [...cmsQueryKeys.venues.all, 'list', params] as const,
  ...
  testimonials: {
    ...
    list: (params?: ListParams) => [...cmsQueryKeys.testimonials.all, 'list', params] as const,
    detail: (id: string) => [...cmsQueryKeys.testimonials.all, 'detail', id] as const,
  },
  
  // FAQs
  faqs: {
    all: ['cms', 'faqs'] as const,
    list: (params?: ListParams) => [...cmsQueryKeys.faqs.all, 'list', params] as const,
  ...
  faqCategories: {
    ...
    detail: (id: string) => [...cmsQueryKeys.faqCategories.all, 'detail', id] as const,
  },
  
  // Blog
  blog: {
    all: ['cms', 'blog'] as const,
    list: (params?: ListParams) => [...cmsQueryKeys.blog.all, 'list', params] as const,
  ...
  blogCategories: {
    ...
    detail: (id: string) => [...cmsQueryKeys.blogCategories.all, 'detail', id] as const,
  },
  
  // Team
  team: {
    all: ['cms', 'team'] as const,
    list: (params?: ListParams) => [...cmsQueryKeys.team.all, 'list', params] as const,
  ...
  quotes: {
    ...
    list: (params?: ListParams) => [...cmsQueryKeys.quotes.all, 'list', params] as const,
  ...
  inquiries: {
    ...
    list: (params?: ListParams) => [...cmsQueryKeys.inquiries.all, 'list', params] as const,
    detail: (id: string) => [...cmsQueryKeys.inquiries.all, 'detail', id] as const,
  ...
  media: {
    ...
    list: (folder?: string) => [...cmsQueryKeys.media.all, 'list', folder] as const,
  },
  ...
  analytics: {
    ...
    pageViews: (params?: { pageType?: string; startDate?: string; endDate?: string }) =>
  ...
  eventTypes: {
    ...
    detail: (id: string) => [...cmsQueryKeys.eventTypes.all, 'detail', id] as const,
  },
