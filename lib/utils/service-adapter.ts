...
import type { Service, ServiceUseCase, ProcessStep, ServicePackage } from '@/lib/types/services';
...
interface DbService {
  ...
  relatedServices?: Array<{ id: string; name: string; slug: string; tagline: string; icon: string }>;
}
